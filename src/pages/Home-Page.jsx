      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="/appoinment/list">Appoinments</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="/login">Login</a>
            </li>
            <li class="nav-item">
              <button className='app-btn' onClick={() => { navigate("/appoinment/book") }}>Get Appointment</button>
            </li>
          </ul>
        </div>
      </nav>
          ...
          <div class="carousel-item active">
            ...
            <div className="image-container">
              ...
              <div className="text-container">
                ...
                <button onClick={() => { navigate("/appoinment/book") }}>Get Appointment</button>
              </div>
            </div>
            {/* chatgpt */}
          </div>
